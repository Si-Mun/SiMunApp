...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        googleSignIn.setOnClickListener {
            ...
            val  activeNet: NetworkInfo? = connectionManager.activeNetworkInfo
            val isConnected : Boolean = activeNet?.isConnectedOrConnecting == true
            if(isConnected){
                signIn()
            }else{
                inet.visibility = View.VISIBLE
                inet.text = "Please Check Your Internet"
